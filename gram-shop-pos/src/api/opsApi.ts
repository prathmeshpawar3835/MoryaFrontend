...
import type { PagedQuery, PagedResponse, StoreDiscount, StoreDiscountRequest, Supplier, SupplierRequest } from '../types'

export const discountApi = {
  list: async (storeId?: number | null, activeOnly = false) =>
    (await axiosClient.get<StoreDiscount[]>('/discounts', { params: cleanParams({ storeId, activeOnly }) })).data,
